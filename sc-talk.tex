...
\date[June 2009] {Modelling complex environmental systems, Bath}
...
\begin{frame}
	\frametitle{A more realistic domain}
            ...
            \begin{center}
            \begin{tabular}{c c}
              \includegraphics[width=2.5in]{figs/wigglytop2-real}\\
            \end{tabular}
            \end{center}
            \end{table}
\end{frame}
...
\begin{frame}
	\frametitle{Multidimensional scaling and within-area distances}
       \bi
         \item Idea: use MDS to to remap points in the domain according to their distance within the domain.
...
\begin{frame}
	\frametitle{Multidimensional scaling refresher}
       \bi
         ...
         [[ diagram here of MDS-d set of coords]]
        \ei
\end{frame}
...
\begin{frame}
	\frametitle{Finding within-area distances}
       \bi
         \item Use a new algorithm of Wood to find the within area distances.
